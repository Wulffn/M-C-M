...
public final class PersonGenerator {
    ...
    private static final String[] LASTNAMES = {"Ahmad", "Ahmed", "Ali", "Andersen", "Andersson", "Andreasen", "Andreassen", "Andresen", "Asmussen", "Bach", "Bak",
        "Bang", "Bech", "Beck", "Bendtsen", "Berg", "Bertelsen", "Berthelsen", "BisgÃ¥rd", "Bisgaard", "Bjerre", "BjerregÃ¥rd",
        "Bjerregaard", "Bonde", "Brandt", "Brodersen", "Bruun", "Buch", "BundgÃ¥rd", "Bundgaard", "Carlsen", "Carstensen",
        "Christensen", "Christiansen", "Christoffersen", "Clausen", "Dahl", "DalgÃ¥rd", "Dalgaard", "DalsgÃ¥rd", "Dalsgaard", "Dam",
        "DamgÃ¥rd", "Damgaard", "Danielsen", "Davidsen", "Enevoldsen", "Eriksen", "Eskildsen", "Fischer", "Frandsen", "Frederiksen",
        "Friis", "Frost", "Gade", "Gregersen", "Hald", "Hansen", "Hassan", "HedegÃ¥rd", "Hedegaard", "Hemmingsen", "Henningsen",
        "Henriksen", "Hermansen", "Hjorth", "Hoffmann", "Holm", "Holst", "HougÃ¥rd", "Hougaard", "Ibsen", "Iversen", "Jacobsen",
        "Jakobsen", "Jensen", "Jeppesen", "Jepsen", "Jespersen", "Jessen", "Johannesen", "Johannsen", "Johansen", "Johansson",
        "Johnsen", "Juhl", "Justesen", "Juul", "JÃ¸nsson", "JÃ¸rgensen", "Karlsen", "Khan", "KirkegÃ¥rd", "Kirkegaard", "Kjeldsen",
        "KjÃ¦r", "KjÃ¦rgÃ¥rd", "KjÃ¦rgaard", "Klausen", "Knudsen", "Koch", "Kofoed", "Kragh", "Kristensen", "Kristiansen",
        ...
        "Michelsen", "Mikkelsen", "Mogensen", "Mohamed", "Mortensen", "Munch", "Munk", "MÃ¼ller", "MÃ¸lgÃ¥rd", "MÃ¸lgaard", "MÃ¸ller",
        "Nguyen", "Nielsen", "Nikolajsen", "Nilsson", "Nissen", "NygÃ¥rd", "Nygaard", "NÃ¸rgÃ¥rd", "NÃ¸rgaard", "Olesen", "Olsen",
        "Olsson", "OvergÃ¥rd", "Overgaard", "Paulsen", "Pedersen", "Persson", "Petersen", "Poulsen", "Rasmussen", "Ravn", "Riis",
        "Schmidt", "Schou", "SchrÃ¸der", "Schultz", "Simonsen", "Skov", "Sloth", "Sommer", "Steffensen", "Svendsen", "Svensson",
        "SÃ¸gÃ¥rd", "SÃ¸gaard", "SÃ¸ndergÃ¥rd", "SÃ¸ndergaard", "SÃ¸rensen", "Thomassen", "Thomsen", "Thorsen", "Thygesen", "ThÃ¸gersen",
        "Toft", "VestergÃ¥rd", "Vestergaard", "Villadsen", "Vinther", "Winther", "Ã˜stergÃ¥rd", "Ã˜stergaard", "Ã…gÃ¥rd", "AagÃ¥rd",
        "Ã…gaard", "Aagaard"};
    static final String[] FIRSTNAMES = {"Aake", "Abdallah", "Abdel", "Abdul", "Abel", "Abraham", "Absalon", "Achim", "Achton",
        ...
        "AdÃ¨le", "Adelena", "Adelfine", "Adelgunde", "Adelheid", "Adelhejd", "Adelina", "Adeline", "Adia", "Adie", "Adils",
        ...
        "Agner", "Agnes", "AgnÃ¨s", "Agneta", "Agnete", "Agnetha", "Agnethe", "Agny", "Ahmed", "Ahrendt", "Ahrent", "Aicha",
        "Aida", "Aies", "Aiko", "Aila", "Aili", "Aima", "Aimas", "AimÃ¨e", "Aimi", "Aimy", "Aina", "Aino", "Aisha", "Aishah",
        ...
        "AmbjÃ¸rn", "Ambrosia", "Ambrosius", "Amdi", "Amelia", "Amelie", "AmÃ©lie", "Amilia", "Amilla", "Amina", "Aminah",
        ...
        "AndrÃ©", "Andrea", "Andreas", "Andrei", "AndrÃ©s", "Andrew", "Andrias", "Andriette", "Andrine", "Andry", "Andy", "AnÃ©e",
        ...
        "Angelique", "AngÃ©lique", "AngÃ¨lique", "Angelita", "Angelo", "Angul", "Angus", "Ania", "Aniara", "Anica", "Anick",
        ...
        "Arletty", "Arly", "Armand", "Armin", "Arna", "ArnbjÃ¸rn", "Arndt", "Arne", "Arnfred", "Arni", "Arnkil", "Arno",
        "Arnold", "Arnt", "Arnth", "Aron", "Arrild", "Arthur", "Artur", "Arved", "Arvid", "AsbjÃ¸rn", "Asdis", "Asfred",
        "Asfrid", "Asgar", "Asger", "Asgerd", "Ashley", "Asja", "Aske", "Asker", "Askil", "Askild", "Asla", "Aslak", "Aslaug",
        "AslÃ¸g", "Asmind", "Asmine", "Asmira", "Asmund", "Asmus", "Asra", "Asser", "Assi", "Assia", "Assika", "Asta", "Asthor",
        ...
        "Barny", "Barry", "Bart", "Bartel", "Bartholemeus", "BartholemÃ¦us", "Bartholomeus", "BartolemÃ¦us", "BartolomÃ¦us",
        ...
        "Bjarni", "Bjarno", "Bjergi", "Bjerke", "Bjerne", "Bjork", "BjÃ¸rk", "BjÃ¸rke", "BjÃ¸rn", "BjÃ¸rno", "Blaise", "Blas",
        ...
        "Bryde", "Brynjolf", "Brynjolfur", "Brynulf", "Bugge", "Buller", "Buris", "Buster", "Buur", "Byrge", "Byrial", "BÃ¸je",
        "BÃ¸rge", "BÃ¸rre", "Baard", "Cajus", "Calle", "Calvin", "Camillas", "Camillo", "Carit", "Carl", "Carlis", "Carlo",
        ...
        "Cristoffer", "Cuno", "Curd", "Curt", "Curtis", "Cyril", "Cyrill", "CÃ¦cilius", "CÃ¦sar", "Daen", "Dagfin", "Dagfinn",
        ...
        "Erwind", "Erwing", "Esaias", "Esajas", "Esben", "Esbern", "EsbjÃ¸rn", "Esge", "Esger", "Eske", "Eskil", "Eskild",
        "Espen", "Esper", "Ethan", "Etlar", "Eug#Ne", "Eugen", "EugÃ¨ne", "Evald", "Evan", "Even", "Evert", "Evin", "Evind",
        ...
        "Freddy", "Frede", "Frederic", "FrÃ©dÃ©ric", "Frederich", "Frederick", "Frederik", "Fredi", "Fredrik", "Fredy",
        ...
        "Gottlieb", "Gravers", "Graves", "Greg", "Greger", "Gregers", "Gregor", "Gregorius", "Greif", "Grejs", "GudbjÃ¸rn",
        ...
        "GÃ¶ran", "GÃ¶sta", "GÃ¸tz", "GÃ¶tz", "Hagbard", "Hagbart", "Hagbarth", "Hagen", "Haggi", "Hajo", "Hakki", "Hakon",
        ...
        "Hubert", "Hugh", "Hugi", "Hugin", "Hugo", "Humphrey", "HÃ¸gne", "HÃ¥gen", "Haagen", "HÃ¥kon", "Haakon", "HÃ¥vard",
        ...
        "Isegrim", "Isidor", "Istvan", "Ivan", "Ivar", "Iver", "Iwan", "Iwar", "Iwer", "IÃ¸rgen", "Jachim", "Jack", "Jackie",
        ...
        "Jimm", "Jimmi", "Jimmy", "Joachim", "Joacim", "Joah", "Joakim", "Jochum", "Jock", "Joel", "JoÃ«l", "Joen", "Johan",
        "Johann", "Johannes", "John", "Johni", "Johnni", "Johnny", "Johny", "Johs", "Jokum", "Jonas", "Jonatan", "Jonathan",
        "Jonny", "Joos", "Joram", "Joran", "Jordy", "Jorge", "Jorn", "Jorry", "Jorst", "JosÃ©", "Josef", "Joseph", "Josh",
        "Joshua", "Joshva", "Josiah", "Josias", "Jost", "Josua", "Josva", "Jovan", "Jozef", "Juan", "Jules", "Julian",
        "Julius", "Juri", "Jussi", "Just", "Justian", "Justin", "Justus", "JÃ¸gvan", "JÃ¸ren", "JÃ¸rg", "JÃ¸rgen", "JÃ¸rk",
        "JÃ¸rlief", "JÃ¸rn", "Jaan", "Kain", "Kaino", "Kaleb", "Kali", "Kalle", "Kamillo", "Kamo", "Karel", "Kari", "Karim",
        ...
        "Klaudius", "Klaus", "Klaves", "Klavs", "Klemen", "Klemens", "Klement", "Klemmen", "Knud", "Knut", "KolbjÃ¸rn",
        ...
        "Kristofer", "Kristoffer", "KrÃ¦n", "KrÃ¦sten", "KrÃ¸j", "Kuan", "Kuno", "Kunz", "Kurd", "Kurt", "Kurth", "KÃ¥re", "Kaare",
        ...
        "Matt", "Matthes", "Matthfus", "Matthias", "Matthies", "Matthis", "MatthÃ¦us", "Matti", "Mattias", "Mattis", "Matts",
        "MattÃ¦us", "MatÃ¦us", "Mauri", "Maurice", "Maurits", "Mauritz", "Maxim", "Maxime", "Maximilian", "Maximillian", "Meck",
        ...
        "Mourits", "Mouritz", "Moust", "Muhammad", "Mylius", "MÃ¥rten", "Napoleon", "Natan", "Natanael", "Nataniel", "Nathan",
        ...
        "Niss", "Nivan", "Njal", "Noah", "Noal", "Noel", "NoÃ«l", "Norbert", "Norman", "Normann", "Obert", "Octavio",
        ...
        "Preben", "PredbjÃ¸rn", "Prosper", "Quintus", "Qvan", "Qvintus", "Racid", "Radolf", "Radulf", "Rafael", "Ragn",
        ...
        "Rom-O", "Roman", "Romann", "Romano", "Romanus", "Romeo", "RomÃ©o", "Ronald", "Ronaldo", "Rone", "Ronn", "Ronni",
        ...
        "Sigbert", "SigbjÃ¸rn", "Sigbrand", "Sigbrandt", "Siger", "Sigfred", "Sigfrid", "Sigfried", "Sigfus", "Sigge", "Sigger",
        ...
        "Steinar", "SteinbjÃ¸rn", "Stellan", "Sten", "Stener", "Stephan", "Stephen", "Stevan", "Steve", "Steven", "Stig",
        "Stiig", "Stinus", "Stiven", "Stone", "Strange", "Stuart", "Stubbe", "Sture", "Sune", "Suni", "Svante", "Svein",
        "Sveinn", "Sven", "Svend", "Svende", "Svenege", "Svenn", "Svenne", "Svenning", "SvenÃ¥ge", "Svenaage", "Sverke",
        "Sverkel", "Sverre", "Sverri", "Sylvest", "Sylvester", "Syrach", "Syrak", "SÃ¦mund", "SÃ¸lver", "SÃ¸nnich", "SÃ¸nnik",
        "SÃ¸ren", "SÃ¸rinus", "Tade", "Tage", "Tago", "Taico", "Tais", "Tajco", "Tajs", "Tamas", "Tammes", "Tano", "Tapio",
        "Tarben", "Tarek", "Tarik", "Taus", "Tave", "Tavs", "Teddi", "Teddy", "Teis", "Teit", "Tejn", "Tejs", "Temme", "Temmi",
        "Teobald", "Teodor", "Terje", "Terkel", "Terkil", "Terkild", "Terman", "Termann", "Terri", "Terry", "Teys", "ThadÃ¦us",
        ...
        "Thommy", "Thonny", "Thony", "Thor", "Thorald", "Thoralf", "Thorben", "ThorbjÃ¸rn", "Thord", "Thore", "Thorer",
        ...
        "Thorvald", "Thorvil", "Thorvild", "Thorwald", "Thue", "Thune", "Thure", "Thyge", "ThÃ¸ge", "ThÃ¸ger", "Tias", "Tibor",
        "Ticho", "Till", "Tilo", "Timm", "Timme", "Timmi", "Timmo", "Timmy", "Timo", "Timoteus", "Timothy", "Tinny", "Tino",
        "Tinus", "Tito", "Tjalfe", "Tjelle", "TjÃ¸rk", "TjÃ¸rn", "Tobby", "Tobias", "Toby", "Togi", "Toivo", "Toke", "Toki",
        "Tolvar", "Tolver", "Tomas", "Tomasz", "Tomm", "Tommas", "Tommi", "Tommy", "Tonnes", "Tonni", "Tonnis", "Tonny",
        "Tony", "Toralf", "Torben", "TorbjÃ¸rn", "Tord", "Tordur", "Tore", "Torfin", "Torfinn", "Torgni", "Torgny", "Torgot",
        ...
        "Turf", "Turmund", "Tycho", "Tyge", "TÃ¸ger", "TÃ¸nnes", "TÃ¸rk", "Ubbe", "Uffe", "Uffo", "UlfbjÃ¸rn", "Ulff", "Ulric",
        ...
        "Vithus", "Vito", "Vittus", "Vitus", "Vladimir", "Volmar", "Volmer", "VÃ¥ge", "Vaage", "Waclaw", "Wagn", "Wagner",
        ...
        "Wladimir", "Wladislaw", "Wladyslaw", "Wolfgang", "Wolmer", "WÃ¥ge", "Waage", "Xenius", "Yann", "Yannick", "Yannik",
        "Yngvar", "Yngvard", "Yngve", "Younes", "Yuri", "Yvan", "Yves", "Zacharias", "Zakarias", "Zaki", "Zanno", "Zapp",
        "Zean", "Zenius", "Zeth", "Ziad", "Zier", "Zilas", "Zimon", "Zoltan", "Zoran", "Zygmund", "Ã˜ivind", "Ã˜jvind", "Ã˜rni",
        "Ã˜rnulf", "Ã˜ssur", "Ã˜sten", "Ã˜vli", "Ã˜ystein", "Ã˜yvind", "Ã…bjÃ¸rn", "AabjÃ¸rn", "Aage", "Ã…mund", "Aamund", "Aaron",
        "Ã…smund", "Aasmund", "Abbelone", "Abbie", "Abeline", "Abelone", "Abigael", "Abigail", "Achena"};
